...
core.register_node("currency:safe", {
	description = S("Safe"),
	...
	allow_metadata_inventory_move = function(pos, from_list, from_index, to_list, to_index, count, player)
		...
		if not has_safe_privilege(meta, player) then
			core.log("action", player:get_player_name().." tried to access a safe belonging to "
	...
	on_metadata_inventory_move = function(pos, from_list, from_index, to_list, to_index, count, player)
		core.log("action", player:get_player_name().." moves stuff in safe at "..core.pos_to_string(pos))
	end,
	on_metadata_inventory_put = function(pos, listname, index, stack, player)
		core.log("action", player:get_player_name().." moves stuff to safe at "..core.pos_to_string(pos))
	end,
	on_metadata_inventory_take = function(pos, listname, index, stack, player)
		core.log("action", player:get_player_name().." takes stuff from safe at "..core.pos_to_string(pos))
	end,
